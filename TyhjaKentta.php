    ...
    <div class="row">
      ...
      <h1 class="otsikko" style="font-size:35px;color:rgba(255, 0, 0, 0.5);">virhe</h1><br>
                <div class="vahvistusboksi" >
                    <h1 style="text-align:center;padding-top:15px;font-weight:bolder;">! ETUKUPONKINUMERO ON PAKOLLINEN !</h1><BR>
                    <HR>
                    <p>
                    Lunastaaksesi etukupongin sinun täyttyy antaa etukupongin numero
                    </p>
...
function countDown(secs,elem) {
  ...
  "<br><br>"+"VOIT SEN JÄLKEEN KOKEILLA UUDESTAAN SYÖTTÄMÄLLÄ SAAMSI ETUKUPONKINUMEROA";
	if(secs < 2) {
		clearTimeout(timer);

            ...
            $ForeignKeyCheckkysely = mysqli_query($conn, $ForeignKeyCheck) or die (mysqli_error($conn));
                ...
                $mail->CharSet = 'UTF-8';
                  ...
                  $message = '<strong><h2>ARVOISA ASIAKKAAMME</h2></strong>
                              Teidät on nyt lisätty Tuottavuusklinikan uutiskirjeen tilaajalistalle</p>
                              <p>Tulette saaman jatkossa ajankohtaista kaikista uusista tuottavuuden liittyvistä tietoiskuista</p>
                              <p>Voitte myös käydä itse lataamassa uutiskirjeet luettavaksenne <a href=https://chpc.fi/Uutiskirjeet.php>TÄSTÄ</a></p>
                              <br/>
      ...
      <div class="col-xl body">
        ...
        <br>
                <div class="vahvistusboksi">
                    ...
                    <a href="Uutiskirjeet.php"><h5>siirry uutiskirjeet välilehteen</h5></a>
                    <p style="text-transform:none;font-size: 20px;padding: 5px;">

...
$sql1="SELECT Lause from tbl_lauseet WHERE Lause_Tunnus = 'W-DB-21';";
    ...
    <div class="row">
      ...
      <h1 class="otsikko" style="font-size:35px;color:rgba(255, 0, 0, 0.5);">virhe</h1><br>
                <div class="vahvistusboksi" >
                    ...
                    <a href="RekisteroidyVaiheB.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:4.5em;" class="Muokkaa btn btn-outline-danger text">takaisin</button></a>

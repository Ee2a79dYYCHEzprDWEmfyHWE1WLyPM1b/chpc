                ...
                <div class="vahvistusboksi" >
                    ...
                    ?>
                      ...
                      <div class="painikkeet">
                        <a href="uutiskirjetilauPERUUTUS.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:7em;width:80%;" class="Muokkaa btn btn-outline-danger text">Siirry takaisin lomakkeeseen</button></a> 
                      </div>
                <br>
      </div>
    </div>  

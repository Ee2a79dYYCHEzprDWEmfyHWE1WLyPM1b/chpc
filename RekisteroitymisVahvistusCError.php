...
$sql1="SELECT Lause from tbl_lauseet WHERE Lause_Tunnus = 'W-DB-22';";
$result_1=mysqli_query($conn,$sql1);
$resultCheck=mysqli_num_rows($result_1);

//Haetaan vahvistusViesti
$sql2="SELECT Lause from tbl_lauseet WHERE Lause_Tunnus = 'W-DB-23';";
      ...
      <h1 class="otsikko" style="font-size:35px;color:rgba(255, 0, 0, 0.5);">virhe</h1><br>
                <div class="vahvistusboksi" >
                    ...
                    <table style="width:100%;text-align:center;">
                        ...
                        <tr>
                            <td><?php  echo  $_SESSION['Asiakasnumero'];?></td>
                            <td><?php  echo  $_SESSION['Etunimi'];?></td>
                            <td><?php  echo  $_SESSION['Sukunimi'];?></td>
                            <td><?php  echo  $_SESSION['Sähköposti'];?></td>
                            <td><?php  echo  $_SESSION['Käyttäjätunnus'];?></td>
                        </tr>
                    </table>
                      <?php session_destroy() ?>

                    <h5 style="margin-top:2.5em;">
                    ...
                    <a href="UUsiHenkilö.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:4.5em;" class="Muokkaa btn btn-outline-danger text">takaisin</button></a>
                    <a href="NollaaSalasanaC.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:24em;" class="Muokkaa btn btn-outline-danger text">Tilaa uusi salasana</button></a>
                            </div>
                <br>
      </div>
    </div>  

    ...
    while($row =mysqli_fetch_assoc($result_HaeKantaAsiakkuus)){
        ...
        $mail->Password   = 'K_?eEdX=yW5Y';            // SMTP account password example
                  ...
                  $message = '<strong><h2>ARVOISA ASIAKKAAMME</h2></strong>
                              Teidät on nyt lisätty tuottavuusklinikan uutiskirjeen tilaaja listalle</p>
                              <p>Tulette saaman jatkossa ajankohtaista kaikista uusista tuottavuuden liittyvistä tietoiskuista</p>
                              <p>Voitte myös käydä itse lataamassa uutiskirjeet luettavaksenne <a href=http://localhost/Tuottavuusklinikat/Uutiskirjeet.php>TÄSTÄ</a></p>
                              <br/>
    ...
    <div class="row">
      ...
      <h1 class="otsikko" style="font-size:35px;color:#28a745;">Onneksi Olkoon</h1><br>
                <div class="vahvistusboksi">
                    <p>ONNEKSI OLKOON, VIESTIN LÄHETYS ONNISTUI</p>
...
function countDown(secs,elem) {
  ...
  element.innerHTML = "Siirryt automaattisesti ETUSISIVULLE "+secs+" sekunnin kuluttua...";
  if(secs < 2) {
    clearTimeout(timer);

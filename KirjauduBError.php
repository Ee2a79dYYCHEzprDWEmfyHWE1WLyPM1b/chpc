...
<head>
  <title>CHPC- Virhe kirjautumisessa</title>
  <meta charset="utf-8">
      ...
      <div class="col-xl body">
        ...
        <div class="vahvistusboksi">
          ...
          <table style="width:100%;text-align:center;">
            ...
            <tr>
              <td><?php echo  $_SESSION['Kayttajatunnus']; ?></td>
        ...
        <div class="painikkeet">
          <a href="KirjauduVaiheB.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:4.5em;" class="Muokkaa btn btn-outline-danger text">takaisin</button></a>
          <a href="NollaaSalasanaB.php"><button type="submit" name="rekisteroidyB" id="Rekisteroidy" style="outline:none;margin-left:24em;" class="Muokkaa btn btn-outline-danger text">Tilaa uusi salasana</button></a>
        </div>
        <br>
      </div>
    </div>
...
function countDown(secs,elem) {
	...
	element.innerHTML = "Sinut siirretään automaattisesti omalle asiakasprofiili sivuille "+secs+" sekunnin kuluttua...";
	if(secs < 2) {
		clearTimeout(timer);

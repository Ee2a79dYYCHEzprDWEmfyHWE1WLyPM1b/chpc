                ...
                if($ViiteAvaimenTarkistusKysel = 1)
                    {
                      $LisaaUusiAsiakas ="INSERT INTO tbl_asiakkaat 
                        ...
                        VALUES ('$Asiakasnumero','$Etunimi','$Sukunimi','$Sahkoposti','$Puhelin','$Titteli','$Y_tunnus','EI','EI','$Lisays_PVM')";
                                                                ...
                                                                if($Muokaka_KuittiNumeroKysely == 1)
                                                                  {
                                                                      ...
                                                                      $message = '<html><body>';
                                                                      $message = '<h3>Arvoisa asiakkaamme teille on luotu lukuoikeustunnukset Tuottavuusklinikoiden sivuille. Alla käyttäjätunnus</h3>';
                                                                      ...
                                                                      if ($mail->send()) 
                                                                          { 
                                                                            echo "<div class='alert alert-success' style='background-color: rgb(166,241,166,0.6);color:black;display:block;text-align: center;font-size: 18px;border-radius: 0px 0px 0px 0px;height:15em;'>
                                                                                  ...
                                                                                  <br><br>
                                                                                  <strong>
                                                                                  <a href='Ostoskori.php' style='text-transform:uppercase;text-decoration:none;'>Palaa ostoskoriin</a>
                                                                                  </strong>
                                                                                  <br><br>

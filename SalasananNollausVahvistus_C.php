...
<html lang="fi-FI">
<head>
  <title>CHPC- Salasanan palauttaminen</title>
  <meta charset="utf-8">
...
<div class="container">
    <div class="row">
      <div class="col-xl body">
        <p class="otsikko">uusi salasana vaihe, C, etenee</p>
        <br>
                <div class="vahvistusboksi">
                    ...
                    <a href="KirjauduVaiheC.php"><h5>KIRJAUDU JÄRJESTELMÄÄN</h5></a>
                    <p style="text-transform:none;font-size: 20px;padding: 5px;">
                    HUOM! jos et löydä lähettämämme sähköpostia saapuneet kansiosta, tarkista roskapostikansio.
                    <br>
                    Mikäli et edelleenkään löydä, ota yhteys asiakaspalvelumme <a href="mailto:info@chpc.fi">info@chpc.fi</a> 
                    </p>
                </div>
      </div>
    </div>  

...
$sql_HaeAhinta = "SELECT Hinta FROM tbl_lukuoikeudethinta";
              ...
              $Snimi = $row['Sukunimi'];
                if ($PaaKayttaja === $Anro)
                    ...
                    else
                    {
                      ...
                      echo "<div class='col-1'><a href='Poista_Asiakas_Ostokori.php?AN=$row[Asiakasnumero]' <i style='margin-left:1em;' class='fas fa-trash' data-toggle='tooltip' data-placement='top' title='Poista henkilö'></i></a></div>";
                    }
...
$LasketaanehenkiloitaTulos = $conn->query($Lasketaanehenkiloita);
  ...
  ?>
      ...
      <br>
      <div class="row LisääUusiHenkilö" style="display: flex;">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 "><a href="UusiHenkilö_Ostoskori.php"><i  class="fas fa-plus vasenplus"></i>&nbsp;&nbsp;&nbsp;Lisää henkilö ostoskoriin</a> </div>
      </div>
    </div>
    <br>
...
$Muokkaa_LuoikeusTiedot = "UPDATE tbl_ostoskori SET Lukuoikeus_Alkaa='$TamaPaiva_UUSI',Lukuoikeus_Paattyy='$lukuoikeusPAATTYY_UUSI' WHERE KuittiNro='$KuittiNro'";
...
if($Kuponki == NULL)
    {
      ...
      $Muokkaa_LuoikeusTiedot = "UPDATE tbl_ostoskori SET Loppusumma='$Loppusumma' WHERE KuittiNro = '$KuittiNro'";
                    ...
                    if($Lostaja_Asiakasnumero === $PaaKayttaja)
                          {
                            ...
                            A_hinta='$Ahinta'
                              WHERE Asiakasnumero = '$PaaKayttaja'";
